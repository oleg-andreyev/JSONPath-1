JSONPath for PHP 7.0 ![Test](https://github.com/SoftCreatR/JSONPath/workflows/Test/badge.svg?branch=php-70) 
=============
...
1. Add to the `require`-section of your composer.json: `"softcreatr/jsonpath": "dev-php-70"`
